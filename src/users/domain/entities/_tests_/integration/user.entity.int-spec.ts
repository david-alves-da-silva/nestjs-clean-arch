...
describe('UserEntity integration tests', () => {
  describe('Constructor method', () => {
    it('Should throw an error when creating a user invalid name', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        name: null,
      };
    ...
    it('Should throw an error when creating a user invalid email', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        email: null,
      };
    ...
    it('Should throw an error when creating a user invalid password', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        password: null,
      };
    ...
    it('Should throw an error when creating a user invalid createdAt', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
  ...
  describe('Update method', () => {
    it('Should throw an error when update a user invalid name', () => {
