...
describe('UsersController e2e tests', () => {
  ...
  describe('PATCH /users', () => {
    ...
    it('should return an error with a 404 code when throw NotFoundError with an invalid id', async () => {
      const res = await request(app.getHttpServer())
        .patch('/users/fakeId')
        .set('Authorization', `Bearer ${accessToken}`)
        .send(updatePasswordDto)
    ...
    it('should return an error with a 422 code when the oldPassword field is invalid', async () => {
    ...
    it('should return an error with a 422 code when the password does not match', async () => {
    ...
    it('should return an error with a 401 code when the request is not authorized', async () => {
      const res = await request(app.getHttpServer())
        .patch('/users/fakeId')
        .expect(401)
        .expect({
