...
import { InvalidPasswordError } from '@/shared/application/errors/invalid-password-errors'
describe('UpdatePasswordCase unit tests', () => {
  ...
  it('Should update a password', async () => {
    const hashPassword = await hashProvider.generateHash('1234')
    const spiUpdate = jest.spyOn(repository, 'update')
    ...
    expect(spiUpdate).toHaveBeenCalledTimes(1)
